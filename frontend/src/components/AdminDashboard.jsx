                ...
                <div className="card-body">
                  <div className="d-flex d-sm-block justify-content-between">
                    <div className="border-bottom-sm border-translucent mb-sm-4">
                      ...
                      <p className="mt-2 fs-6 fw-bold mb-0 mb-sm-4">3 <span className={`fs-8 ${theme === 'dark' ? 'text-wite' : 'text-body'} lh-lg`}>Leads Today</span></p>
                    </div>
                ...
                <div className="card-body">
                  <div className="d-flex d-sm-block justify-content-between">
                    <div className="border-bottom-sm border-translucent mb-sm-4">
                      ...
                      <p className="mt-2 fs-6 fw-bold mb-0 mb-sm-4">12 <span className={`fs-8 ${theme === 'dark' ? 'text-white' : 'text-body'} lh-lg`}>This Week</span></p>
                    </div>
              ...
              <div className="border-bottom border-translucent">
                ...
                <ul className="list-group list-group-flush">
                  <li className={`list-group-item d-flex justify-content-between align-items-center bg-transparent list-group-crm fw-bold text-body fs-9 py-2 ${theme === 'dark' ? 'text-white' : 'text-body'}`}>
                    <span className={`fw-normal fs-9 mx-1 ${theme === 'dark' ? 'text-white' : 'text-body'}`}><span className="fw-bold">1. </span>None </span><span className={`${theme === 'dark' ? 'text-primary' : 'text-body'}`}>(65)</span>
                  </li>
                  <li className={`list-group-item d-flex justify-content-between align-items-center bg-transparent list-group-crm fw-bold text-body fs-9 py-2 ${theme === 'dark' ? 'text-white' : 'text-body'}`}>
                    <span className={`fw-normal mx-1 ${theme === 'dark' ? 'text-white' : 'text-body'}`}><span className="fw-bold">2. </span>Online Store</span><span className={`${theme === 'dark' ? 'text-primary' : 'text-body'}`}>(74)</span>
                  </li>
                  <li className={`list-group-item d-flex justify-content-between align-items-center bg-transparent list-group-crm fw-bold text-body fs-9 py-2 ${theme === 'dark' ? 'text-white' : 'text-body'}`}>
                    <span className={`fw-normal fs-9 mx-1 ${theme === 'dark' ? 'text-white' : 'text-body'}`}><span className="fw-bold">3.</span> Advertisement</span><span className={`${theme === 'dark' ? 'text-primary' : 'text-body'}`}>(32)</span>
                  </li>
                  <li className={`list-group-item d-flex justify-content-between align-items-center bg-transparent list-group-crm fw-bold text-body fs-9 py-2 ${theme === 'dark' ? 'text-white' : 'text-body'}`}>
